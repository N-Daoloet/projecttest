                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="text-align: center">
                                                        ...
                                                        @elseif($item->STATUS_APPROVER==7)
                                                            <td style="color: red"><br>ไม่อนุมัติ โดยเจ้าหน้าที่งานบุคคล</td>
                                                        @elseif($item->STATUS_APPROVER==4)
                                                            <td style="color: green"><br>อนุมัติ โดยผู้อำนวยการ</td>
                                                        @elseif($item->STATUS_APPROVER==5)
                                                            <td style="color: red"><br>ไม่อนุมัติ โดยผู้อำนวยการ</td>
                                                        @elseif($item->STATUS_APPROVER==3)
                                                            <td style="color: red"><br>ไม่อนุมัติ โดยหัวหน้าฝ่าย</td>
                                                        ...
                                                        @elseif($item->STATUS_APPROVER==2)
                                                                ...
                                                                <td><br><button class="btn btn-outline-success btn-sm" type="button" onclick="btnsumit({{$item->ABSENT_ID}},'{{$item->ABSENTTYPE_NAME}}','{{$item->USER_FNAME}}','{{$item->USER_LNAME}}');"><i class="feather icon-edit-2"></i>อนุมัติ</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{url('approveleavedirector')}}" method="POST">
            <div class="modal-body">
                ...
                <input type="hidden" name="approveleave" value="5">
