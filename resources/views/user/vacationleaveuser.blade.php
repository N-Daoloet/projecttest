                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="daytype" id="daytype" style="background-color:#ffffff" {{((int)$usedab->followers) > ((int)$limit->vacation_limit)?'disabled':''}} required>
...
<script language="javascript" type="text/javascript">
    ...
    var chk = 0;
    var daysumold = 0;
    var limit = "{{$limit->vacation_limit}}";
