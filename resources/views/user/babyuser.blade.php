                                ...
                                <div class="card">
                                    ...
                                    <form action="{{url('saveabsentsick')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-block">
                                            <input type="hidden" name="ABSENTYPE_ID" value="5">
                                            <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control"  value="{{$data->USER_EMAIL}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="form-label">ขอลาไปช่วยเหลือภริยาที่คลอดบุตรตั้งแต่วันที่</label>
