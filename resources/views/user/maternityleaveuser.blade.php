                                ...
                                <div class="card">
                                    ...
                                    <form action="{{url('saveabsentsick')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-block">
                                            <input type="hidden" name="ABSENTYPE_ID" value="3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="daytype" id="daytype" style="background-color:#ffffff" {{((int)count($usedab)) > ((int)$limit->maternity_limit)?'disabled':''}}>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="ABSENT_REASON" style="background-color:#ffffff">
                                                    </div>
                                                </div>    
                                        </div>
                                        <div class="col-md-12"><br>
                                            ...
                                            @if((int)count($usedab) < (int)$limit->maternity_limit)
...
<script language="javascript" type="text/javascript">
    ...
    var chk = 0;
    var daysumold = 0;
    var limit = "{{$limit->maternity_limit}}";
