                                ...
                                <div class="card">
                                    ...
                                    <form action="{{url('saveabsentsick')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <input type="hidden" name="private" value="1">//0ป่วย 1ลากิจ
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="daytype" id="daytype" style="background-color:#ffffff" {{((int)count($usedab)) > ((int)$limit->sickprivate_number)?'disabled':''}} required>
