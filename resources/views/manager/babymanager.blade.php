                                ...
                                <div class="card">
                                    ...
                                    <form action="{{url('saveabsentsick')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <input type="hidden" name="ABSENTYPE_ID" value="4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="ABSENT_WIFE" placeholder=" " style="background-color:#ffffff">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="form-label">คลอดบุตรเมื่อวันที่</label>
                                                        <input type="date" class="form-control"  name="ABSENT_BABY" style="background-color:#ffffff">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="form-label">ช่วงเวลา</label>
                                                        <select class="form-control" name="daytype" id="daytype" style="background-color:#ffffff" {{((int)count($usedab)) > ((int)$limit->baby_limit)?'disabled':''}} required>
